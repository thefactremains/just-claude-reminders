...
import { getListsScript, getRemindersScript, getReminderByIdScript, } from "../applescript/queries.js";
export function registerReadTools(server) {
    // ── Get Reminders (filtered, paginated) ──────────────────────────
    server.registerTool("reminders_get_reminders", {
        ...
        inputSchema: z
            ...
            search: z
                .string()
                .optional()
                .describe("Case-insensitive substring match against title and notes"),
            limit: z
                .number()
                .min(1)
                .max(200)
    ...
    // ── Get Single Reminder ──────────────────────────────────────────
    server.registerTool("reminders_get_reminder", {
    ...
    // ── Get Lists ────────────────────────────────────────────────────
    server.registerTool("reminders_get_lists", {
