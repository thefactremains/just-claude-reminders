...
import { createReminderScript, updateReminderScript, completeReminderScript, deleteReminderScript, } from "../applescript/mutations.js";
export function registerWriteTools(server) {
    // ── Create Reminder ──────────────────────────────────────────────
    server.registerTool("reminders_create_reminder", {
        ...
        inputSchema: z
            ...
            listName: z
                .string()
                .optional()
                .describe("Name of the list to add to (uses default list if omitted)"),
            dueDate: z
                .string()
                .optional()
    ...
    // ── Update Reminder ──────────────────────────────────────────────
    server.registerTool("reminders_update_reminder", {
    ...
    // ── Complete Reminder ────────────────────────────────────────────
    server.registerTool("reminders_complete_reminder", {
    ...
    // ── Delete Reminder ──────────────────────────────────────────────
    server.registerTool("reminders_delete_reminder", {
